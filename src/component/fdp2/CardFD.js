    ...
    return (
        ...
        <Card className="my-4 mx-5 px-4 py-2" style={{ borderRadius: '20px' }} >
            ...
            <div className="row">
                ...
                <div className="col-3">
                    <h6>Interest Earned at Maturity</h6>
            ...
            <div className="row mt-4">
                ...
                <div className="col-8">Representative example: Assumed deposits of Rs. 100,000.00 over 60 months at a rate of 5.5% would result in an interest amount of
