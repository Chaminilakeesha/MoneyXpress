        ...
        <div className="col-2 mx-3">
            <Card className="my-4 mx-5 px-4 py-2" style={{ borderRadius: '40px 5px', width: "100%", textAlign: "center" }} >
                ...
                <Card.Text style={{ fontFamily: 'Poppins-Medium' }}>
                    <div className="my-5">{props.carddet.Mrate1}% - {props.carddet.Mrate2}%</div>
                    <div className="my-5">Rs.{props.carddet.MonAmount}</div>
                    <div className="my-5">Rs.{props.carddet.TotalPayInt}</div>
