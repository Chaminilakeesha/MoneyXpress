...
import CompCardLoanssData from './CompCardLoansData.js';
            ...
            <div className="row justify-content-center mb-3">
                <div className="row w-75 h-auto mt-n5 bg-white " style={{ borderStyle: 'groove', borderRadius: '20px' }}>
                    ...
                    <div className=" col-2 mx-auto">
                        ...
                        <div className="row">
                            <div className="input-group input-group-md  mb-6 col-8">
                                <input type="text" className="form-control mb-5" placeholder="" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"></input>
                            </div>
                            <div className="col-4 h4">Years</div></div>
                    ...
                    <div className=" col-2 mx-auto">
                        <p style={{ textAlign: "left", fontSize: '22px', fontFamily: 'Poppins-Medium' }}>Salary Range</p>
                        <div className="input-group input-group-md  mb-6">
                            <input type="text" className="form-control mb-5" placeholder="" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"></input>
                        </div>
                    </div>
                    ...
                    <div className=" col-2 mx-auto">
                        <p style={{ textAlign: "left", fontSize: '22px', fontFamily: 'Poppins-Medium' }}>Rate Type</p>
                        <div className="input-group input-group-md  mb-6">
                            <input type="text" className="form-control mb-5" placeholder="" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"></input>
                        </div>
                    </div>
...
A fixed deposit. </p>
            ...
            {compshow && <div className="row">
                ...
                <div className="col-2" >
                    <Card className="my-4 mx-5 px-4 py-2" style={{ borderRadius: '40px 5px', width: "100%", textAlign: "center", border: 'none' }} >
                        ...
                        <div style={{ fontFamily: 'Poppins-Medium', marginTop: "35px" }}>
                            ...
                            <div className="my-5">Minimum Rate</div>
                            <div className="my-5">Monthly Amount to be paid</div>
                            <div className="my-5">Total Interest Payable</div>
                ...
                <CompCardLoanssData type="Personal Loan" category="bank" />
                    ...
                    <Tab.Content style={{ fontFamily: 'Poppins-Regular' }}>
                        <Tab.Pane eventKey="first">
                            <div>
                                ...
                                <CardCredData type="Personal Loan" category="bank" />
                        ...
                        <Tab.Pane eventKey="second">
                            <div>
                                ...
                                <CardCredData type="Personal Loan" category="non-bank" />
